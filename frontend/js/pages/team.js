  ...
  function renderCard(t) {
    ...
    return `<div class="card reveal" style="padding:18px">
      ...
      <div style="display:flex;gap:8px;margin-top:14px;justify-content:space-between;flex-wrap:wrap">
        ...
        <button data-tip="Reset two-step sign-in · For a field engineer who lost their phone and recovery codes" data-tip-color="amber" onclick="Auth.showAssistReset(${t.id}, ${esc(JSON.stringify(t.full_name || ''))})" style="padding:7px 14px;font-size:11px;background:rgba(245,166,35,.08);color:var(--amber);border:1px solid rgba(245,166,35,.2);border-radius:7px;cursor:pointer;display:inline-flex;align-items:center;gap:4px"><i class="ti ti-shield-x" style="font-size:12px"></i> Reset 2-step</button>
