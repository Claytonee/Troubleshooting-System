  ...
  async function open(id) {
    try {
      ...
      const body = `
        ...
        <div style="font-size:12px;color:var(--text3);margin-bottom:16px">${esc(e.school_name)} · ${esc(e.category)} · Reported ${e.created_at ? fmtDate(e.created_at) : ageStr(e.hours_open)}${intakeLabel(e)}</div>
