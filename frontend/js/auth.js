...
const Auth = (() => {
  ...
  return { init, showLogin, showApp, logout, checkSession, toggleProfileMenu, showProfile, showChangePassword, submitPasswordChange, goRegister, _switchToEditProfile, _saveProfile, _onAvatarFile };
})();
