...
Every asset in the library has a row here **before** it is used in a film. External assets also keep the
licence text (or a saved copy of the licence page) in their folder. See RESEARCH.md § Licensing gate.

| Asset | Source | Creator | URL / reference | Licence | Commercial | Attribution | AI restriction | Modify | Redistribute | Reviewed |
|---|---|---|---|---|---|---|---|---|---|---|
...
**External 3D models used in the prototype: none.** Candidates evaluated and excluded are listed, with
reasons, in RESEARCH.md.
